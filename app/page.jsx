  ...
  return (
    ...
    <div className="grid-background" >
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="flex flex-col items-center justify-center space-y-2">
              ...
              <p className="text-muted-foreground">Success Ratio</p>
            </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="font-bold text-3xl mb-4">Powerful Features for Your Career Growth</h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="font-bold text-3xl tracking-tighter text-center mb-12">What our users say</h2>
                  ...
                  <div className="flex flex-col space-y-4">
                    ...
                    <blockquote>
                      <p className="text-muted-foreground italic relative">
                        <span className="text-3xl primary absolute -top-4 -left-2">&quot;</span>
                        {testimonial.quote}
                        <span className="text-3xl primary absolute -bottom-4">&quot;</span>
                      </p>
                    </blockquote>
                  </div>
                </CardContent>
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center text-center space-y-4 mx-auto max-w-3xl">
